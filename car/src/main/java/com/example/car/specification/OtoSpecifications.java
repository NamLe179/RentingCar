...
public class OtoSpecifications {
    ...
    public static Specification<Oto> betweensDate(Date ngayBatDau, Date ngayKetThuc) {
        return (root, query, criteriaBuilder) -> {
            return (null != ngayBatDau && null != ngayKetThuc) ? criteriaBuilder.between(root.get("ngayTao"), ngayBatDau, ngayKetThuc): null;
        };
    }
