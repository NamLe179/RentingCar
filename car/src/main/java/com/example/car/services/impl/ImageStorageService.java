...
import com.example.car.customExceptions.StorageException;
import com.example.car.customExceptions.StorageFileNotFoundException;
    ...
    public void store(MultipartFile file, String filename) {
        try {
            if (!isImageFile(file) || file.getOriginalFilename() == null) {
                throw new StorageException("Invalid image format");
            }
            if (file.isEmpty()) {
