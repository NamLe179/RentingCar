...
public class SearchingOtoDto {
    ...
    public static SearchingOtoDto toSearchingOtoDtO(Map<String, Object> params) throws ParseException {
        return SearchingOtoDto.builder()
                ...
                .ngayBatDau(MapUtil.getObject(params, "ngayBatDau", Date.class))
                .ngayKetThuc(MapUtil.getObject(params, "ngayKetThuc", Date.class))
